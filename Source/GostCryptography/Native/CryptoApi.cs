...
namespace GostCryptography.Native
{
	...
	static class CryptoApi
	{
		...
		[return: MarshalAs(UnmanagedType.Bool)]
		[DllImport("advapi32", CharSet = CharSet.Ansi, SetLastError = true)]
		public static extern bool CryptSignHash([In] SafeHashHandleImpl hHash, [In] int dwKeySpec, string sDescription, [In] int dwFlags, [In] [Out] byte[] pbSignature, ref int pdwSigLen);
