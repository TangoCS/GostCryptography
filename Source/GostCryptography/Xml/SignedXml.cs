...
namespace GostCryptography.Xml
{
    ...
    public class SignedXml {
        ...
        private X509CertificateCollection m_x509Collection = null;
        ...
        public const string XmlDsigGost3411_2012_256HMACUrl = "urn:ietf:params:xml:ns:cpxmlsec:algorithms:hmac-gostr3411";
        ...
        public const string XmlDsigGost3411_2012_512HMACUrl = "urn:ietf:params:xml:ns:cpxmlsec:algorithms:hmac-gostr3411";
        ...
        public byte[] SignatureValue {
            ...
            set { m_signature.SignatureValue = value; }
		}
        ...
        public bool CheckSignature(X509Certificate certificate, bool verifySignatureOnly) {
			...
			// TODO: Check key usages to make sure it is good for signing.
			...
			// TODO: Do the chain verification to make sure the certificate is valid.
		...
		private AsymmetricAlgorithm GetNextCertificatePublicKey () {
            while (m_x509Enum.MoveNext()) {
                X509Certificate certificate = (X509Certificate) m_x509Enum.Current;
				if (certificate != null)
				{
        ...
        private static IList<string> KnownCanonicalizationMethods
        {
            get {
                if (s_knownCanonicalizationMethods == null) {
					...
					List<string> safeAlgorithms = new List<string>(); // ReadAdditionalSafeCanonicalizationMethods();
