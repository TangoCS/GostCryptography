...
namespace GostCryptography.Xml
{
	...
	public sealed class GostEncryptedXml
	{
        ...
        /// <summary>
        /// URI алгоритма транспортировки ключей шифрования gost2012-256.
        /// </summary>
        public const string XmlEncGost2012_256KeyTransportUrl = XmlEncGostNamespaceUrl + "transport-gost2012-256";

        /// <summary>
        /// URI алгоритма транспортировки ключей шифрования gost2012-512.
        /// </summary>
        public const string XmlEncGost2012_512KeyTransportUrl = XmlEncGostNamespaceUrl + "transport-gost2012-512";
		...
		/// <returns>Зашифрованное представление XML-элемента.</returns>
		public EncryptedData Encrypt(XmlElement element, X509Certificate certificate)
		{
