...
namespace GostCryptography.Cryptography
{
    ...
    public sealed class Gost3410_2012_256AsymmetricAlgorithm : Gost3410, ICspAsymmetricAlgorithm
    {
        /// <summary>
        ...
        public Gost3410_2012_256AsymmetricAlgorithm() : this(null)
        {
        }
        ...
        [SecuritySafeCritical]
        public Gost3410_2012_256AsymmetricAlgorithm(CspParameters providerParameters)
        {
        ...
        private void SetPassword()
        {
            if (_providerParameters.KeyPassword != null)
            {
                ...
                try
                {
                    CryptoApiHelper.SetProviderParameter(_providerHandle, (int)_providerParameters.KeyNumber,
                        Constants.PP_SIGNATURE_PIN, keyPasswordData);
                }
                finally
                {
        ...
        private byte[] SignHash(byte[] hash)
        {
            ...
            var res = CryptoApiHelper.SignValue(_providerHandle, _providerParameters.KeyNumber, hash, GostAlgorithmType.Gost2012_256);
        ...
        private bool VerifyHash(byte[] hash, byte[] signature)
        {
            ...
            UsingKey(h =>
            {
                res = CryptoApiHelper.VerifySign(_providerHandle, h, hash, signature, GostAlgorithmType.Gost2012_256);
            });
            return res;
        }
        ...
        public override GostSharedSecret CreateKeyExchange(GostKeyExchangeParameters keyParameters)
        {
            ...
            UsingKey(h =>
            {
                res = new GostSharedSecretAlgorithm(_providerHandle, h, new GostKeyExchangeParameters(keyParameters), GostAlgorithmType.Gost2012_256);
            });
        ...
        public override GostKeyExchangeParameters ExportParameters(bool includePrivateKey)
        {
            ...
            UsingKey(h =>
            {
                res = CryptoApiHelper.ExportPublicKey(h, GostAlgorithmType.Gost2012_256);
            });
            return res;
        }
        ...
        public override void ImportParameters(GostKeyExchangeParameters keyParameters)
        {
            ...
            _keyHandleFunc = () =>
            {
                return CryptoApiHelper.ImportPublicKey(_providerHandle, new GostKeyExchangeParameters(keyParameters), GostAlgorithmType.Gost2012_256);
            };
        }
        ...
        private static HashAlgorithm CreateHashAlgorithm(object hashAlg)
        {
            ...
            if (!GetHashAlgorithmOid(hashAlg).Equals(Constants.OID_GR3411_12_256, StringComparison.OrdinalIgnoreCase))
            {
