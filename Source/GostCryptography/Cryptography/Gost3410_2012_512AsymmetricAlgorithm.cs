...
namespace GostCryptography.Cryptography
{
    ...
    public sealed class Gost3410_2012_512AsymmetricAlgorithm : Gost3410, ICspAsymmetricAlgorithm
    {
        /// <summary>
        ...
        public Gost3410_2012_512AsymmetricAlgorithm() : this(null)
        {
        }
        ...
        [SecuritySafeCritical]
        public Gost3410_2012_512AsymmetricAlgorithm(CspParameters providerParameters)
        {
