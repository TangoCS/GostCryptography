...
namespace GostCryptography.Cryptography
{
	...
	/// </summary>
	public sealed class Gost3411_2012_512Hmac : HMAC
	{
        public const string DefaultHashName = "GOST3411_2012_512";
        public const int DefaultHashSize = 512;

        /// <summary>
        /// Конструктор.
        /// </summary>
        [SecuritySafeCritical]
		public Gost3411_2012_512Hmac()
		{
			HashName = DefaultHashName;
			HashSizeValue = DefaultHashSize;

			_keyAlgorithm = new Gost28147SymmetricAlgorithm();
			_hashHandle = CryptoApiHelper.CreateHashHmac(CryptoApiHelper.ProviderHandle, _keyAlgorithm.InternalKeyHandle, Constants.CALG_GR3411_2012_512_HMAC);
		}
		...
		[SecuritySafeCritical]
		public Gost3411_2012_512Hmac(byte[] key)
		{
			if (key == null)
			{
		...
		/// <exception cref="ArgumentNullException"></exception>
		[SecuritySafeCritical]
		public Gost3411_2012_512Hmac(Gost28147 keyAlgorithm)
		{
		...
		{
			var hashHmacHandle = CryptoApiHelper.CreateHashHmac(CryptoApiHelper.ProviderHandle, _keyAlgorithm.InternalKeyHandle, Constants.CALG_GR3411_2012_512_HMAC);
