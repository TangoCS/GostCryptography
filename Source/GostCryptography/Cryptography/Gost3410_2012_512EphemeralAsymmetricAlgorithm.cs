...
namespace GostCryptography.Cryptography
{
	...
	/// </summary>
	public sealed class Gost3410_2012_512EphemeralAsymmetricAlgorithm : Gost3410
	{
        protected override string Gost3410SignatureAlgorithm { get { return "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34102012-gostr34112012-512"; } }

        protected override string Gost3410KeyExchangeAlgorithm { get { return "urn:ietf:params:xml:ns:cpxmlsec:algorithms:transport-gost2012-512"; } }

        /// <summary>
        /// Конструктор.
        /// </summary>
        [SecuritySafeCritical]
		public Gost3410_2012_512EphemeralAsymmetricAlgorithm()
		{
			_provHandle = CryptoApiHelper.ProviderHandle.DangerousAddRef();
			_keyHandle = CryptoApiHelper.GenerateKey(_provHandle, Constants.CALG_DH_GR3410_12_512_EPHEM, CspProviderFlags.NoFlags);
		}
		...
		/// </remarks>
		[SecuritySafeCritical]
		public Gost3410_2012_512EphemeralAsymmetricAlgorithm(GostKeyExchangeParameters keyParameters)
		{
			...
			_provHandle = CryptoApiHelper.ProviderHandle.DangerousAddRef();
			_keyHandle = CryptoApiHelper.GenerateDhEphemeralKey(_provHandle, Constants.CALG_DH_GR3410_12_512_EPHEM, keyParameters.DigestParamSet, keyParameters.PublicKeyParamSet);
		}
		...
		{
			return new GostSharedSecretAlgorithm(_provHandle, _keyHandle, new GostKeyExchangeParameters(keyParameters), GostAlgorithmType.Gost2012_512);
		}
		...
		public override GostKeyExchangeParameters ExportParameters(bool includePrivateKey)
		{
			...
			return CryptoApiHelper.ExportPublicKey(_keyHandle, GostAlgorithmType.Gost2012_512);
		}
